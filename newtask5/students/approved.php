...
<html>
<head>
<title>PUC-Student | Approved Requests</title>
<meta charset="UTF-8">
...
<div class="grid-container">
    ...
    <div class="grid-item item3">
        ...
        // Query to get approved requests for the logged-in student
        $sql = "
            SELECT 
            ...
            WHERE 
                ...
                AND student_req.status = 1"; // 1 = Approved requests
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<p style='color:red;'>No approved requests found.</p>";
        }
        ?>
    </div>
