		...
		<div class="grid-container">
			...
			<div class="grid-item item3">
				...
				<form action="signup3.php" method="post" enctype="multipart/form-data">
					...
					<label for="admid">Admin ID(This will be your User ID after registration):</label><br><br>
					<input type="text" id="admid" class="spc" name="id" size="50" required><br><br>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$query="insert into admin_details values('$id','$name','$email','$dob','$phone','$image','$password')";
