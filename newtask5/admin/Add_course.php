...
<div class="grid-container">
  	...
  	<div class="grid-item item3">
		<form action="Add_course.php" method="post" enctype="multipart/form-data">
			...
			<input style="background-color:#001c3d;font-size:25px;color:white;text-align:center;width:200px;float:right" type="submit" value="Add Course" name="add"><br><br>
		</form> 
	...
	if(isset($_POST['add'])){
		...
		if ($course_id == 'ACC 101' || $course_id == 'CSE 110' || $course_id == 'EEE 101' || $course_id == 'EEE 102') {
		    $query1="insert into course_under_semester values('1st','$course_id','$course_title')";
		...
		elseif ($course_id == 'CSE 103' || $course_id == 'CSE 111' || $course_id == 'CSE 112' || $course_id == 'EEE 211') {
		    $query2="insert into course_under_semester values('2nd','$course_id','$course_title')";
		...
		elseif ($course_id == 'CSE 211' || $course_id == 'CSE 212' || $course_id == 'CSE 221' || $course_id == 'CSE 222') {
		    $query3="insert into course_under_semester values('3rd','$course_id','$course_title')";
		    ...
		    $query4="insert into course_under_semester values('4th','$course_id','$course_title')";
		...
		$query="insert into course_list values('$course_id','$course_title','$course_credit')";
